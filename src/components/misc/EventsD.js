...
export default ({
  heading = (
    <>
      Our <span tw="text-white">Events & Gatherings</span>
    </>
  ),
  description = "Light up and connect! Join us at local gatherings, industry events, and experiences we curate. Spark conversations, explore cannabis culture, and create unforgettable memories.  Let's elevate the vibe, together.",
