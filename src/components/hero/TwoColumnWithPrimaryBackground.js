...
import logo from "../../images/sobonsfumos/sbftv-logo512.png";

import serverIllustrationImageSrc from "images/sobonsfumos/chefchaouen-banner.jpg";
...
export default ({
  heading = "Morroco SBF's Experience",
  description = "Visit morroco guided by SBF himself and enjoy the spoils.",
  ...
  const navLinks = [
    <NavLinks key={1}>
      ...
      <NavLink href="/experience">SBS's Experience</NavLink>
    </NavLinks>
  ];
  return (
